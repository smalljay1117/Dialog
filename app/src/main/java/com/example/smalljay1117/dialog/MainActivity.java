...
public class MainActivity extends AppCompatActivity
        implements DialogInterface.OnClickListener, MyDialogFragment.DialogFragmentDataImp {
    ...
    public void clickAlertDialog(View view) {
        new AlertDialog.Builder(this).setMessage("笨阿母")
    ...
    public void clickAlertDialogYesNo(View view) {
        ...
        new AlertDialog.Builder(this).setMessage("正妹")
    ...
    public void clickAlertDialogYesNoCancel(View view) {
        new AlertDialog.Builder(this).setMessage("我是正妹!!")
    ...
    public void clickAlertDialogFragment(View view) {
